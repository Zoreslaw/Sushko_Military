    ...
    models: [
      {
        slug: 'mini',
        title: 'SVM\u2011MINI',
        subtitle: 'Компактний мобільний комплекс відеоспостереження',
        tags: ['До 48 год', 'До 1 км', '2\u00d7 аналог + 1\u00d7 IP'],
        image: '/svm-mini.jpg',
        category: 'svm',
      },
      {
      ...
      },
      {
        slug: 'nich',
        title: 'SVM\u2011NICH',
        subtitle: 'Мобільний комплекс відеоспостереження для контролю під\'їзних шляхів у складних умовах',
        tags: ['До 1 км', '50 м', '2 канали'],
        image: '/svm-nich.jpg',
        category: 'svm',
      },
    ],
